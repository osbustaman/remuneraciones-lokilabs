        ...
        try:
            ...
            if object.exists():
                ...
                data = {
                    ...
                    "phone_user": object_contact_phone.con_phone_contact if object_contact_phone.con_phone_contact else '',
                    "email_corporativo": object.email,
                    "email_personal": object_contact.con_mail_contact if object_contact.con_mail_contact else '@',
